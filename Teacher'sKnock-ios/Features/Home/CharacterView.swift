...
struct CharacterView: View {
    ...
    let cheerMessages = [
        "오늘도 파이팅!", "합격이 보여요!", "조금만 더 힘내!",
        "멋진 선생님이 될 거예요!", "포기하지 마세요!", "당신을 믿어요!",
        "오늘 공부 파이팅!", "3월의 교실에서 만나요!", "꾸준함이 답이다!",
        "넌 할 수 있어!", "오늘 하루도 멋져!", "너의 능력을 믿어봐",
        "선생님, 저 벌써 3월이 기다려져요!","너의 교실은 이미 반짝거려.",
        "합격이라는 마침표가 아닌, 꿈의 시작점!","지금 흘리는 값진 땀방울.",
        "너는 이미 훌륭한 선생님.", "칠판 앞에 선 선생님 모습, 너무 멋져!",
        "아이들이 선생님을 기다리고 있어!", "조금 느려도 괜찮아",
        "오늘 하루도 정말 수고했어.", "마지막까지 펜 꽉 잡아!",
        "오늘 공부한 내용, 시험에 무조건 출제!", "교실 문을 여는 그 설레는 순간을 상상해봐."
    ]
